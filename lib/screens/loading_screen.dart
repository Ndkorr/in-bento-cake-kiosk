...
class _LoadingOverlayState extends State<LoadingOverlay>
  ...
  void _startAnimation() async {
    ...
    while (mounted && !_shouldStop) {
      ...
      for (int i = 0; i < 3; i++) {
        ...
        if (_randomEndPoint == i && cycleCount > 0) {
          _shouldStop = true;
          _finishAnimation();
          return;
        }
      ...
      if (_randomEndPoint == 3 && cycleCount > 0) {
        _shouldStop = true;
        _finishAnimation();
        return;
      }
      ...
      for (int i = 0; i < randomOrder.length; i++) {
        ...
        if (_randomEndPoint == 4 && i == 1 && cycleCount > 0) {
          // Stop with 1 dot (2 icons converted)
          _shouldStop = true;
          _finishAnimation();
          return;
        }
        if (_randomEndPoint == 5 && i == 2 && cycleCount > 0) {
      ...
      if (_randomEndPoint == 6 && cycleCount > 0) {
        _shouldStop = true;
        _finishAnimation();
        return;
      }
  ...
  void _finishAnimation() async {
    ...
    if (mounted) {
      ...
      debugPrint('Navigate to menu with: ${widget.orderType}');
